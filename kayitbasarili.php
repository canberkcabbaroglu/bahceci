...
<section>
  <div class="container text-center"> 
    ...
    <h4 class="text-center">İletişim bilgileriniz tarafımıza ulaşmıştır.En kısa sürede tarafınızıa dönüş yapılacaktır.</h4>
    <button class="btn btn-danger btn-md"><a href="index.php" style="color:white">Geri Dön</a></button>
  </div>
</section>
