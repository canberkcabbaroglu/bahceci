...
<body>
    ...
    <div class="container">
      <div class="row  align-items-center justify-content-center text-center">
        ...
        <div class="col-lg-8 align-self-baseline mt-3">
          <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#exampleModalLong">SİZİ ARAYALIM</button> 
        </div>
          ...
          <div class="row grid mt-auto">      
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
             <div class="row mt-4 ml-2 mr-2">
               ...
               <div class="col-lg-6 col-md-12 col-sm-12">
                <h4>WHTC</h4>
                <p style="font-size:14px;">"Yılın En İyi Tüp Bebek Merkezi" Ödülü </p>
              </div>
            </div>
          </div> 
 ...
 <section>
  <div class="container text-center" > 
     ...
     <h5 class="section-title text-center">Bizimle İletişime Geçtiğiniz için Teşekkür Ederiz!</h5> 
     <h4 class="text-center">İletişim bilgileriniz tarafımıza ulaşmıştır.En kısa sürede tarafınıza dönüş yapılacaktır.</h4> 
     <button class="btn btn-danger btn-md"><a href="http://localhost/wordpress/" style="color:white">Geri Dön</a></button>
